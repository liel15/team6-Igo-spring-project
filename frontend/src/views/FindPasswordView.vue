            ...
            >
              ...
              >
                ...
                >
                    ...
                    >
                      ...
                      <div class="text-center mb-10">
                        ...
                        <div class="text-gray-500 fw-semibold fs-6">
                          계정이 없으신가요 ?
                          <a @click="goToSignUp" class="link-primary fw-bold" style="cursor:pointer">회원가입</a>
                        </div>
                        <!--end::Link-->
                      </div>
                      <!--begin::Heading-->
                      ...
                      <div class="d-grid mb-10">
                        ...
                        >
                          ...
                          <span class="indicator-label">비밀번호 찾기</span>
                          <!--end::Indicator label-->
                        </button>
                      </div>
                      <!--end::Action-->
                  ...
                  <!--end::Wrapper-->
                  <!--begin::Footer-->
                  <div class="w-lg-500px d-flex flex-stack"></div>
                  <!--end::Footer-->
                </div>
                <!--end::Content-->
              </div>
...
<script setup>
import { ref } from "vue";
import { usefindStore } from "@/stores/test"; // Pinia 스토어 가져오기
...
const store = usefindStore(); // Pinia 스토어 사용
const { findPw, error } = store; // 스토어에서 함수와 에러 상태 가져오기

// 비밀번호 찾기 함수 호출
function findPassword() {
  findPw(id.value, name.value, email.value); // 사용자가 입력한 ID와 이름, email을 넘겨줌
}
