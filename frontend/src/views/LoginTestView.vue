      ...
      <div class="d-flex flex-column flex-lg-row flex-column-fluid">
          ...
          <!--end::Body-->
            ...
            <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                ...
                <!--end::Image-->
                <!--begin::Title-->
                <h1 class="d-none d-lg-block fs-2qx fw-bolder text-center mb-7" style="color:white">Fast, Efficient and Productive</h1>
                <!--end::Title-->
                <!--begin::Text-->
                <div class="d-none d-lg-block fs-base text-center" style="color:white">
