  ...
  <div class="d-flex flex-column flex-root" id="kt_app_root" style="height: 100vh">
    ...
    <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            >
              ...
              <div class="row g-3 mb-9">
                ...
                <div class="col-md-6">
                  ...
                  >
                    <img alt="Logo" src="/images/google.png" class="h-15px me-3" />Sign in
                    with Google</a
                  >
                  <!--end::Google link=-->
                </div>
              ...
              <div class="separator separator-content my-14">
                <span class="w-200px text-gray-500 fw-semibold fs-7"
                  >회원 정보로 로그인</span
                >
              </div>
              <!--end::Separator-->
              ...
              <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                ...
                <a
                  @click="goToFinId()"
                  class="link-primary"
                  style="margin-left: 55%; cursor: pointer"
                  >아이디 찾기</a
                >
                <!--end::Link-->
              ...
              <div class="text-gray-500 text-center fw-semibold fs-6">
                아직 회원이 아니신가요?
                <a @click="goToSignUp()" class="link-primary" style="cursor: pointer"
                  >회원가입</a
                >
              </div>
              <!--end::회원가입-->
      ...
      <div
        ...
        style="background-image: url('/images/trip.jpg'); width: 70%"
      >
        <!--begin::Content-->
