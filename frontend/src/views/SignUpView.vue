<template>
 ...
 <div class="d-flex flex-column flex-root" id="kt_app_root">
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
                ...
                <label for="image">
                  <!-- 파일을 선택하면 이 부분이 갱신 -->
                  <img :src="previewUrl || '@/assets/images/cat_run.png'" alt="Selected Image" />
                </label>
              </div>
                 ...
                 <div class="fv-row mb-8 mt-8">
                  ...
                  <fieldset style="border: 1px solid #ccc; padding: 15px; margin-bottom: 20px;">
                    ...
                    <!--begin::성별-->
                    <div>
                      <input type="checkbox" class="form-check-input" value="남성" v-model="selectedGender" />남성
                      <input type="checkbox" class="form-check-input ms-10" value="여성" v-model="selectedGender" />여성
                    </div>
					...
					<div class="w-lg-500px d-flex flex-stack px-10 mx-auto">
						...
						<div class="me-10">
							...
							<button class="btn btn-flex btn-link btn-color-gray-700 btn-active-color-primary rotate fs-base" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" data-kt-menu-offset="0px, 0px">
								<img data-kt-element="current-lang-flag" class="w-20px h-20px rounded me-3" src="@/assets/images/cat_run.png" alt="" />
								...
								<div class="menu-item px-3">
									<a href="#" class="menu-link d-flex px-5" data-kt-lang="English">
										<span class="symbol symbol-20px me-4">
											<img data-kt-element="lang-flag" class="rounded-1" src="@/assets/images/cat_run.png
                      " alt="" />
										</span>
                      ...
                      " alt="" />
								...
								<div class="menu-item px-3">
									<a href="#" class="menu-link d-flex px-5" data-kt-lang="German">
										<span class="symbol symbol-20px me-4">
											<img data-kt-element="lang-flag" class="rounded-1" src="@/assets/images/cat_run.png" alt="" />
										</span>
				...
				<div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url(assets/media/misc/auth-bg.png)">
					...
					<div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
						...
						<a href="index.html" class="mb-0 mb-lg-12">
							<img alt="Logo" src="@/assets/images/cat_run.png" class="h-60px h-lg-75px" />
						</a>
						<!--end::Logo-->
						<!--begin::Image-->
						<img class="d-none d-lg-block mx-auto w-275px w-md-50 w-xl-500px mb-10 mb-lg-20" src="@/assets/images/cat_run.png" alt="" />
						<!--end::Image-->
						<!--begin::Title-->
...
export default {
  ...
  async signup() {
    try {
      ...
      // 2. 이미지가 선택된 경우에만 별도로 FormData로 전송
      if (this.img) {
        ...
        // 서버로 이미지 파일을 전송
        await axios.post(
          "http://localhost:9000/backend/api/auth/uploadImage.do",
          formData,
          {
            headers: {
  ...
  // methods: {
  //   async getFileName(event) {
  //     this.img = event.target.files[0]; // 선택된 이미지 파일을 img에 저장하기
  //   },
  ...
  //           userName: this.name,
  //           userEmail: this.email,
  //           userTel: this.tel_num,
  //           userBitrh: this.birth_date,
  //           userImage: this.img,
  //      
  //         }
  //       );
  //       alert("회원가입 성공"); // 회원가입 성공 메시지
